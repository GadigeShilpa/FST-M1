...
public class Activity5 {
    ...
    public void smsTest() {
    	...
    	//driver.findElement(AppiumBy.xpath("//android.widget.TextView[@content-desc=\"Messages\"]")).click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.id("recipient_text_view")));//recipient_text_view
        //wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.widget.MultiAutoCompleteTextView[@resource-id='recipient_text_view']")));
        // Find the element to add recipient
        driver.findElement(AppiumBy.id("recipient_text_view")).sendKeys("999148292");
        // Press ENTER
       ...
       wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.id("compose_message_text")));
        ...
        // Enter text to send"
       //driver.findElement(AppiumBy.xpath("//android.widget.RelativeLayout/android.view.View[1]")).sendKeys("Hello from Appium");
