...
public class GoogleChromeActivity2 {
	...
	public void loginTestwithCorrectCreds() throws InterruptedException {
		...
		Thread.sleep(5000);
		driver.findElement(AppiumBy.androidUIAutomator(UiScrollable+ ".scrollForward(4).getChildByText(className(\"android.widget.TextView\"), \"Login Form\")"));

		// Wait for page to load
		wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.widget.TextView[@text='Login Form']"))).click();
		wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.webkit.WebView[@text='Login Form']/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText[1]"))).sendKeys("admin");
		wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.webkit.WebView[@text='Login Form']/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText[2]"))).sendKeys("password");
