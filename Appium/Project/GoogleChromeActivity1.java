...
public class GoogleChromeActivity1 {
	...
	public void toDoList() throws InterruptedException {
		...
		driver.findElement(AppiumBy.androidUIAutomator(
				UiScrollable + ".scrollForward(4).getChildByText(className(\"android.view.View\"), \"To-Do List\")"));
		// Thread.sleep(10000);
		...
		WebElement taskInputBox = driver.findElement(AppiumBy.xpath(
				"//android.webkit.WebView[@text=\"Todo List\"]/android.view.View/android.view.View/android.view.View[1]/android.widget.EditText"));
		...
		List<WebElement> tasksList = driver.findElements(AppiumBy.xpath(
				"//android.webkit.WebView[@text=\"Todo List\"]/android.view.View/android.view.View/android.view.View[2]/android.view.View"));
...
//	        Thread.sleep(10000);
		...
		List<WebElement> tasksListNew = driver.findElements(
				AppiumBy.xpath("//android.webkit.WebView[@text=\"Todo List\"]/android.view.View/android.view.View"));
