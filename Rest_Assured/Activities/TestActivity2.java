...
public class TestActivity2 {
	...
	public void addNewUserFromFile() throws IOException {
		// Import JSON file
		FileInputStream inputJSON = new FileInputStream("FST_RESTAssured/src/test/java/activitiesREST/activity2Json.json");
	...
	public void getUserInfo() {
		...
		File outputJSON = new File("FST_RESTAssured/src/test/java/activities/userGETResponse.json");
